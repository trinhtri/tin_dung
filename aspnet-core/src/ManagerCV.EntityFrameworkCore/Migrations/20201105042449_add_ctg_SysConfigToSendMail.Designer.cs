...
namespace ManagerCV.Migrations
{
    ...
    [Migration("20201105042449_add_ctg_SysConfigToSendMail")]
    partial class add_ctg_SysConfigToSendMail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagerCV.Models.CtgLanguage", b =>
                {
                    ...
                    b.ToTable("CtgLanguages");
                });

            modelBuilder.Entity("ManagerCV.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("LuongMongMuon")
                        .HasColumnType("nvarchar(1000)")
                        .HasMaxLength(1000);
            ...
            modelBuilder.Entity("ManagerCV.Models.SysConfigToSendMail", b =>
                {
                    ...
                    b.ToTable("SysConfigToSendMails");
                });
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ManagerCV.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ManagerCV.Authorization.Users.User", null)
                        .WithMany("Claims")
